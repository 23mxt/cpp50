...
//     void setNewConnectionCallback(const TcpConnectionCallback&onNewConnection);
//     void setMessageCallback(const TcpConnectionCallback&onMessage);
//     void setCloseCallback(const TcpConnectionCallback&onClose);
//     void handleNewConnectionCallback();
//     void handleMessageCallback();
//     void handleCloseCallback();
//     bool isClosed();
